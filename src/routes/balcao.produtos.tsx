        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm" onClick={closeModal}>
          ...
          >
            ...
            <div className="p-6 space-y-4">
              ...
              {/* Row 5: Image URL */}
              <div>
                <label className="text-xs font-semibold text-foreground uppercase tracking-wide">URL da Imagem</label>
                <input
                ...
                />
                {form.image_url && (
                  <img src={form.image_url} alt="preview" className="mt-2 h-16 w-16 rounded-md object-cover border border-border" onError={(e) => (e.currentTarget.style.display = "none")} />
                )}
              </div>
